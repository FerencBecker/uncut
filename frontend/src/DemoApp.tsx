...
// Demo/showcase application (existing App content)
const DemoApp = () => {
  ...
  const replayAnimation = withErrorHandling((id: string, startTime: number) => {
    ...
    if (showEasterEgg) setTimeout(() => recordTouchResponse(startTime, `animation-${id}`), 0);
  });
              ...
              <>
                ...
                <section>
                  ...
                  >
                    ...
                    />
                    <p style={{ marginTop: '1rem', color: 'var(--text-secondary)', textAlign: 'center' }}>
                      64px touch targets • Hover: scale 1.4 + rotate (disabled in kiosk mode) • Active: scale 1.5 +
                      pulse • Gold gradient
                    </p>
                  </div>
                </section>
                ...
                <section>
                  ...
                  >
                    ...
                    />
                    <p style={{ marginTop: '1rem', color: 'var(--text-secondary)', textAlign: 'center' }}>
                      Batched appearance (5 at a time) • 0.5s between batches • Scale 0→1.3→1 over 6s • Optimized for
                      performance
                    </p>
                  </div>
                </section>
                ...
                <section>
                        ...
                        },
                        {
                          ...
                          studioAddress: {
                            ...
                            location: {
                              ...
                              coordinates: { latitude: 46.253, longitude: 20.1414 },
                  ...
                  <p style={{ marginTop: '1rem', color: 'var(--text-secondary)', textAlign: 'center' }}>
                    Dark gradient background (#1A1A1A→#2C2C2C) • Rotating gold overlay (30s) • Continuous loop • Full
