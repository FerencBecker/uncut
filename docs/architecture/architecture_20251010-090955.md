...
**Screensaver Animation Patterns** (`frontend/src/components/map/Screensaver.tsx`):
- **Continuous Loop Animation**: `useScreensaverAnimation` hook manages infinite animation cycles
